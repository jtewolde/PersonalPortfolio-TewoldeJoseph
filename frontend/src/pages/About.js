        ...
        <div className="about-background" id = "about">
            ...
            <div className="about-container">
                ...
                <p className="about-text">
                    ...
                    Hello there! My name is Joseph Tewolde! It's a pleasure to meet you!
                    Please take a moment to look around my website and get to know me a little better through my projects and experiences!
